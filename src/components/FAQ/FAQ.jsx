    ...
    return (
        <div className="faq">
            ...
            <div className="collapse collapse-arrow bg-base-200 mb-3">
                ...
                <div className="collapse-content">
                    <p>Listing your property with Skyline Realty is simple. Just reach out to our team and we'll guide you through the process, ensuring your property gets the exposure it deserves.
                    </p>
                </div>
            </div>
            <div className="collapse collapse-arrow bg-base-200 mb-3">
