  ...
  return (
    <div>
      ...
      <div className="mt-20">
        ...
        <h3 className="text-3xl my-7 font-extrabold text-center text-slate-500">
          Our Agents & Offices
        </h3>
        ...
        <div className="hero min-h-[400px] rounded-lg mt-10" style={{ backgroundImage: 'url(https://i.ibb.co/PNpwBbs/group-business-workers-smiling.jpg)' }}>
