...
const Blog = () => {
	return (
		...
		<p>
				HOMES ARE SELLING FASTER IN THESE 3 U.S. CITIES
In February, homes for sale were spending an average of 44 days on the market – but in a few bustling metro areas, they were selling much quicker, according to the RE/MAX National Housing Report.
				</p>
		</h1> */}
					</div>
				</div>
